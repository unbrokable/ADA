...
namespace BayesClassifier
{
    internal static class TelegramTextSender
    {
        ...
        private const string AlternateBotTokenEnvironmentVariable = "TELEGRAM_TOKEN";
        private const string ShortBotTokenEnvironmentVariable = "BOT_TOKEN";
        private const string ChatIdEnvironmentVariable = "TELEGRAM_CHAT_ID";
        private const string ShortChatIdEnvironmentVariable = "CHAT_ID";
        ...
        public static async Task SendAsync(string message, string botTokenOverride, string chatIdOverride)
        {
            ...
            string botToken = FirstNonEmpty(
                ...
                Environment.GetEnvironmentVariable(ShortBotTokenEnvironmentVariable),
            ...
            string chatId = FirstNonEmpty(
                ...
                Environment.GetEnvironmentVariable(ShortChatIdEnvironmentVariable),
                ConfigurationManager.AppSettings["TelegramChatId"]);

            if (string.IsNullOrWhiteSpace(botToken))
            {
                throw new InvalidOperationException("Telegram bot token is missing. Set --bot-token, TELEGRAM_BOT_TOKEN, TELEGRAM_TOKEN, BOT_TOKEN, or TelegramBotToken in App.config.");
            }
