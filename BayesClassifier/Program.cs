    ...
    static class Program
    {
        ...
        private static int RunCommandLine(string[] args)
        {
            try
            {
                ...
                string botToken = GetOptionValue(args, "--bot-token") ?? GetOptionValue(args, "--token");
        ...
        private static void PrintUsage()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Telegram credentials can be supplied by arguments, environment variables, or App.config.");
        }
    }
}
